...
def decrypt_json_body(text):
    return ujson.loads(decrypt(text, request.headers['key']))
...
# 机器人parser
parser_with_robot_auth = base_parser.copy()
parser_with_robot_auth.add_argument('robot_id', location='headers', type=str)
list_parser_with_robot_auth = list_parser.copy()
list_parser_with_ad_auth.add_argument('robot_id', location='headers', type=str)
json_parser_with_robot_auth = json_parser.copy()
json_parser_with_robot_auth.add_argument('robot_id', location='headers', type=str)
