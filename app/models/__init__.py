...
from app.models.base_model import UserOperationLog, ApiOperationLog, AdminApiOperationLog, AdminOperationLog, RobotApiOperationLog, audit_log
...
event.listen(Company, 'after_insert', partial(audit_log, constants.Operation.create))
event.listen(Company, 'after_update', partial(audit_log, constants.Operation.update))
event.listen(Company, 'after_delete', partial(audit_log, constants.Operation.delete))
